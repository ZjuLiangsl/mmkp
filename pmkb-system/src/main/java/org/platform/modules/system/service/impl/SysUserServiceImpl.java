...
import org.platform.modules.system.entity.*;
import org.platform.modules.system.mapper.*;
import org.platform.modules.system.model.SysUserSysDepartModel;
import org.platform.modules.system.service.ISysUserService;
import org.platform.modules.system.vo.SysUserDepVo;
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	public Result<?> checkUserIsEffective(SysUser sysUser) {
		...
		//情况1：根据用户信息查询，该用户不存在
		if (sysUser == null) {
			result.error500("The user does not exist");
